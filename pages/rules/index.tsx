...
export default function Rules() {
    ...
    const planADatas = [
        ...
        },
        {
            ...
            content: (
                <p className={`m-0 ${myFontIran.className} text-right rtl`}>
                    تمامی جفت ارزهای فارکس، کریپتوکارنسی، شاخص ها و فلزات قابل استفاده هستند.
                </p>
            ),
        },
        {
        ...
        },
        {
            ...
            content: (
                <p className={`m-0 ${myFontIran.className} text-right`}>
                    ...
                    <br />
                    امکان بستن تریدها در روز های تعطیل (شنبه و یکشنبه) در نمادهای کریپتوکارنسی وجود ندارد.
                    <br />

                    پس از باز شدن مارکت در روز دوشنبه، ممکن است با فاصله قیمتی زیادی از حدضرر شما عبور کند.
                    <br />

                    آیا در روزهای شنبه و یکشنبه میتوان در کریپتوکارنسی ها ترید کرد؟
                    <br />
                    ...
                    <Accordion multiple className='grid grid-cols-2 gap-y-4 ml-12 mb-24 mt-8'>
                        ...
                        <AccordionTab header="پرداخت و تقسیم سود چگونه انجام میشود ؟">
                            <p className={`m-0 ${myFontIran.className} text-right rtl`}>
                                ...
                                برداشت سود، در حال حاضر از طریق کریپتو (TETHER – TRC20) میسر است.
                                <br />
