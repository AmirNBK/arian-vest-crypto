...
export const SendForgotPasswordCode = (email_or_username) => {
    return defaultApi({
        method: "post",
        url: `${base_url}accounts/reset/password/request/`,
        data: {
            email_or_username,
        },
    })
...
export const CurrencyTransfer = (user, account, name, price, tracking_code, certification) => {
    ...
    return defaultApi({
        method: "post",
        url: `${base_url}currency-transfer/`,
        data: formData,
        headers: {
...
export const VerifyForgotPasswordCode = (email_or_username, reset_code) => {
    return defaultApi({
        method: "post",
        url: `${base_url}accounts/reset/password/code/verify/`,
        data: {
            email_or_username,
            reset_code
        },
...
export const ResetPassword = (email_or_username, temp_token, password, confirm_password) => {
    return defaultApi({
        method: "post",
        url: `${base_url}accounts/reset/password/`,
        data: {
            email_or_username,
            temp_token,
            password,
...
export const purchaseAccount = (name, user, accounts, price, payment_invoice) => {
    const formData = new FormData();
    formData.append("user", user);
...
export const createInvoice = (price_amount, order_id, description) => {
    ...
    myHeaders.append("x-api-key", "4XVWH3Q-TY5MZRX-H78AA7B-Y5GSDPX");
    ...
    const raw = JSON.stringify({
        ...
        "ipn_callback_url": "https://www.virafunding.com/result/success",
        "success_url": "https://www.virafunding.com/result/success",
        "cancel_url": "https://www.virafunding.com/result/failed"
    });
    ...
    return fetch("https://api.nowpayments.io/v1/invoice", requestOptions)
